...
The next steps for BJDS involve planning out resources and commitments towards achieving these goals. As Phase 2 comes to a close soon, Phase 3 is will be achievable with the help of the SIG-UI-UX community effort as a whole. As a core contributor towards this design system, I will be looking to help kick start some of these new pages to get the ball going. 

If you would like to help contribute towards the efforts here—by reviewing, writing or letting us know to remind you when we want some feedback—let us know on [Discord](https://discord.com/invite/o3de)! All the extra eyes and hands are a massive help.
