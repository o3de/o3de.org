...
|--------------------|---------------------------------------------------------------------|-------------------------------------------------------|
| project-name       | Name of the current project.                                        | On Windows, to the current project's name             |
| project-cache-path | Full path to the project cache folder.                              | On Windows, to the current project's cache path       |
| project-path       | Supplies the path to the project that the AP should use (required). | On Windows, to the current project's path             |                                  
| engine-path        | Supplies the engine path to the engine.                             | On Windows, to the engine registered with the project |
...
| dependencyScanMaxIteration      | Used to limit the number of recursive searches per line when running dependencyScanPattern.                                                                                                                 | Default is 800.                                                                                 |
