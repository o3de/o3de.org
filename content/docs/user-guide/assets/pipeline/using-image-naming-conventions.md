...
You can use any existing or created [image processing presets](/docs/user-guide/assets/creating-image-processing-presets). To do this, append the suffix to the end of the file name before you add it to your O3DE directory.
