...
| `--clean` | Cleans the target Android device by uninstalling any pre-existing projects before deploying. |     | Unistalling the project also deletes all the assets deployed as well. |
