...
The .names files have certain files that should not be modified, they are used by the system to create a key into a database of text fields. 
...
### Scenario #1 A new method is exposed for Scripting and we wish to improve it for Script Canvas
...
We will use AWSGameLiftPlayer in this example
 ...
 ![Image 0](/images/user-guide/scripting/script-canvas/text-replacement/text-replacement-0.png)

 Write click on any of the nodes under AWSGameListPlayer

![Image 1](/images/user-guide/scripting/script-canvas/text-replacement/text-replacement-1.png)

And selected "Generate Translation"
...
![Image 2](/images/user-guide/scripting/script-canvas/text-replacement/text-replacement-2.png)

All the names are now separated by a space and the naming follows the Script Canvas naming convention to use CamelCase.

#### Changing the Category

We have succesfully generated translation data for a node, but it's category is still under "Other". To change this we will now edit the generated file *AWSGameLiftPlayer.names*
...
![Image 3](/images/user-guide/scripting/script-canvas/text-replacement/text-replacement-3.png)


## Scenario 2 The node already has translation data generated and we wish to change it

In this case, we do not need to generate a new translation file, instead we just need to edit it.

![Image 2](/images/user-guide/scripting/script-canvas/text-replacement/text-replacement-1.png)
