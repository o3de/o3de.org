...
![Image NOT FOUND](/images/user-guide/interactivity/user-interface/components/layout/ui-editor-components-nesting-row.png)

Within the layout row are four columns.

![Image NOT FOUND](/images/user-guide/interactivity/user-interface/components/layout/ui-editor-components-nesting-column.png)
...
![Image NOT FOUND](/images/user-guide/interactivity/user-interface/components/layout/ui-editor-components-nesting-nested.png)
...
![Image NOT FOUND](/images/user-guide/interactivity/user-interface/components/layout/ui-editor-components-nesting-cell.png)
