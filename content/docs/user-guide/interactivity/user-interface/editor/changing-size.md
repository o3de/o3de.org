...
![Canvas size dropdown menu on the toolbar](/images/user-guide/game_ui_editor/ui-canvas-change-size.png)

1. Select the size you want or click **Other** to enter a custom canvas size.
![Common canvas sizes list](/images/user-guide/game_ui_editor/ui-canvas-select-size.png)
