...
In the **Properties** pane of the [**UI Editor**](/docs/user-guide/features/interactivity/user-interface/editor/using.md), expand **RadioButton** and do the following, as appropriate:
**Interactable**
