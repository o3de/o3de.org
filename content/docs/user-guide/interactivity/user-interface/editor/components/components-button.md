...
![UI Editor Button component](/images/user-guide/game_ui_editor/ui-editor-components-button.png)
...
 
+ To define borders for a sliced image type, open the **Sprite Editor**. To do this, click the arrow (open-in) ![Open In Icon](/images/user-guide/game_ui_editor/ui-editor-components-button-1.png) next to **Sprite path**.
