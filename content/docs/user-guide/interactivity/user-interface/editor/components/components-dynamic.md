...
![Layout element and child in Hierarcy pane](/images/user-guide/game_ui_editor/ui-editor-components-dynamic-child.png)
...
![Order setting 'Starting with' set to 'Horizontal'](/images/user-guide/game_ui_editor/ui-editor-components-dynamic-fillorder.png)
