...
**Topics**
+ Fader
+ [Mask](/docs/user-guide/interactivity/user-interface/editor/components/components-mask)
+ [Flipbook Animation](/docs/user-guide/interactivity/user-interface/editor/components/components-other-flipbook)
