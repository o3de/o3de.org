...
![Canvas data for five loaded UI canvases.](/images/user-guide/interactivity/user-interface/editor/ui-editor-debugging-ui-canvases-1.png)
...
![Draw call information for four UI canvases.](/images/user-guide/interactivity/user-interface/editor/ui-editor-debugging-ui-canvases-2.png)
...
| XTex | The number of draw calls that occur when the shader supported maximum of 16 textures is reached. To reduce the number of these calls, you can use a texture atlas. For more information, see [Using Texture Atlases](/docs/user-guide/interactivity/user-interface/texture-atlases). |
...
![Rectangular bounds displayed for nested scrollboxes.](/images/user-guide/interactivity/user-interface/editor/ui-editor-debugging-ui-canvases-3.png)
...
![Data for 13 unique textures in the current frame.](/images/user-guide/interactivity/user-interface/editor/ui-editor-debugging-ui-canvases-4.png)
...
![Entering the ui_ReportDrawCalls command.](/images/user-guide/interactivity/user-interface/editor/ui-editor-debugging-ui-canvases-5.png)
...
For more information, see [Using Texture Atlases to Reduce UI Draw Calls](/docs/user-guide/interactivity/user-interface/texture-atlases/texture-atlases-using-texture-atlases-to-reduce-ui-draw-calls).
