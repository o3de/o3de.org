...
Scripted Entity Tweener parameters provide flexibility and allow you to customize your tweener animations. Use the parameters with a [timeline](/docs/user-guide/user-interface/animating/tweener-timeline/) for a variety of possibilities.
...
**easeMethod **
Specifies the [easing type](/docs/user-guide/user-interface/animating/tweener-understanding-types/) to apply to the tween.
