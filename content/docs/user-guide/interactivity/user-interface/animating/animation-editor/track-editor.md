...
+ In the [**Animation Editor**](_index/), choose **View**, **Track Editor** or **View**, **Both**.
...
The play or record point of the animation sequence is shown as a vertical magenta slider on the timeline. Move the play or record point, and the properties of the UI elements in the [**Animation Editor**](_index/) change to the values specified by the animation tracks.
