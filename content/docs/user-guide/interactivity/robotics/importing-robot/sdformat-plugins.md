...
If you decide to use articulations in your imported robot, you might need to enable motor in articulation links of your joints manually in order to be able to adjust their trajectory.
