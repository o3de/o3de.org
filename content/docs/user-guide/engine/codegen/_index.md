...
1. AZ Code Generator returns a list of generated files to the build system.

1. The build system completes the build process, including the generated code in the build.
