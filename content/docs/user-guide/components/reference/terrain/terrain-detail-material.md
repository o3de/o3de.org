...
Detail materials are standard materials that you can create with [Material Editor](/docs/atom-guide/look-dev/tools/material-editor/). They are assigned to the terrain through surface tag names that are generated by gradients. This allows you to assign many materials across a large terrain surface and blend between them. Detail materials are displayed on the terrain within the **Detail material render distance** from the camera.
...
1. Creating the materials you want to apply to your terrain in the [Material Editor](/docs/atom-guide/look-dev/tools/material-editor/).
