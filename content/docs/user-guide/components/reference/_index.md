...
| [Post-processing Volumes](/docs/user-guide/components/reference/atom/post-processing-volumes/) | A collection of components that define layers, volumes, areas, and weights for post-processing effects (PostFX). |
