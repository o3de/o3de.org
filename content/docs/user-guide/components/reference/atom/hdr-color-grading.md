...
| **Midtones Color** | Color to apply to midtones, which are the pixel brightness values in between shadows and highlights. | Eight bits per channel color: `0` to `255` | `26`,`26`,`255` |
...
| **Channel Mixing Green** | Transforms the green color channel into a different color | Floating point number per channel: `0.0` to infinity | `0,1,0` |
| **CHannel Mixing Blue** | Transforms the blue color channel into a different color | Floating point number per channel: `0.0` to infinity | `0,0,1` |
| Final Adjustment |
| **Weight** | Strength of the **Final Adjustment** properties. | `0.0` to `1.0` | `1.0` |
