...
+ **[Simple Motion](/docs/user-guide/components/reference/simple-motion/)** component - Uses a single motion for your actor\.
+ **[AnimGraph](/docs/user-guide/components/reference/animgraph/)** component - Uses an animation graph to control your actor's behavior\.
