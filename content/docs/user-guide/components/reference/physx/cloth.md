...
{{< note >}}
The component wind properties create wind that affects only the cloth referenced by the component. To create wind that can affect multiple components across multiple entities, see [Create Wind Forces](/docs/learning-guide/tutorials/physx/wind-provider).
{{< /note >}}
