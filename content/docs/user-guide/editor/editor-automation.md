...
**Important**
 In order to use the editor bindings, your O3DE installation needs to be configured to be able to build the editor and tools\. See [Running O3DE Setup Assistant](/docs/userguide/lumberyard-launcher-using.md) for details\.
