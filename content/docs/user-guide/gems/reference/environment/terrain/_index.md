...
| - | - |
| [Terrain Physics Collider](/docs/user-guide/components/reference/terrain/terrain_physics_collider/) | Provides terrain data to a physics collider in the form of a heightfield and surface to material mapping. |
