...
| [Terrain Surface Material List](/docs/user-guide/components/reference/terrain/surface_material_list/) | Defines mappings between a surface type and a render material. |