...
|  |
| --- |
|  The ChatPlay Gem is deprecated and will be removed in a future version of O3DE\. It has been replaced by the [Twitch Chat API Gem](/docs/user-guide/gems/reference/chatplay/twitch-chat/)\.  |
...
+ [Intro to ChatPlay](/docs/user-guide/gems/reference/chatplay/twitch-chatplay-system/)
