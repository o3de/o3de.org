...
| Topic | Description |
|--|--|
| [Networking framework](/docs/user-guide/networking/) | The core Networking framework used by O3DE, which the Multiplayer Gem is built on top of. |
| [AzAutoGen](/docs/user-guide/engine/autogen/) | The AzAutoGen code generation system, used to create [auto-components](./autocomponents) for projects using the Multiplayer Gem. |
| [Networking Gem C++ API Reference](/docs/api/gems/multiplayer/) | The C++ API reference for classes provided by the Multiplayer Gem. |
