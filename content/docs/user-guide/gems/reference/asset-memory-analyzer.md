...
1. Configure and build your project in profile mode.
    ...
    ```cmd
    cmake -B <Build dir> -S . -G "Visual Studio 16 2019" 
...
![\[The ImGUI overlay dispalying the Asset Memory Analyzer.\]](/images/user-guide/gems/assetmemoryanalyzer/ui-asset-memory-analyzer-A.png)
