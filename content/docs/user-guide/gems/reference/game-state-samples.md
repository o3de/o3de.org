...
The GameState Samples gem uses the [GameState Gem](/docs/user-guide/gems/game-state.md) to provide a set of sample game states that control the high\-level flow of a game\.
