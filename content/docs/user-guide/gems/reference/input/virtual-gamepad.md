...
1. In UI Editor, add the [UI components](/docs/user-guide/interactivity/user-interface/editor/components.md) **VirtualGamepadButton** and **VirtualGamepadThumbStick** to the UI canvas.
