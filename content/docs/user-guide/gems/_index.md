...
Gems come from the different sources:
...
1. Register the Gem, if it's not already. O3DE already registers Gems its bundled with. However, you must register Gems from an external source. Refer to [Register Gems to a Project](/docs/user-guide/project-config/register-gems/).
