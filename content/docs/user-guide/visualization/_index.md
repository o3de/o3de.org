...
| [Open Particle System](/docs/user-guide/visualization/particles) | Produce particle effects using O3DE's native particle system |
| Particles | Produce particle effects using a third-party plugin [PopcornFX](https://www.popcornfx.com/o3de/) integrated into Atom. |
