...
1. Implement the `Reflect` method to reflect the type to the [Serialization Context](/docs/user-guide/engine/serialization/entity-system-reflection-serialization-context/) and [Edit Context](/docs/user-guide/components/development/edit-context/) contexts.
