...
To use the **[PhysX Ragdoll](/docs/user-guide/components/reference/physx/physx-ragdoll/)**, add it to an entity in O3DE Editor\. You can then follow the procedures below to create and control the physical representation of the ragdoll\.
