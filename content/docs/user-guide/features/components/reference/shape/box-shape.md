...
| **Edit** | Click to enter Edit mode. In Edit mode, you can modify the dimensions of the Box Shape in the Perspective view by clicking and dragging the black handles on the sides of the Box Shape. While in Edit mode, the Edit menu in the menu bar displays available actions and hotkeys. To exit Edit mode, choose **Done** in the component interface. |  |  |
