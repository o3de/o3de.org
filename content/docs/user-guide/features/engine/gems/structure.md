...
All gems that ship with Lumberyard are built as AZ modules\. When you build a gem as an AZ module, the gem uses the initialization functions expected by the AZ framework\. An AZ module gem has public interfaces that are [event buses](/docs/user-guide/features/engine/ebus/_index.md) and is better integrated with the new [component entity system](/docs/userguide/components/intro.md)\.
...
For more information about gems, see [Add modular features and assets with Gems](/docs/user-guide/features/gems)\.