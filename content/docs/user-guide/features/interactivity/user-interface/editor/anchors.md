...
description: ' Use the Transform2D''s anchors and offset settings to set a UI element''s
  position and size relative to its parent''s edges in Lumberyard. '
...
1. In the **Hierarchy** pane of the [**UI Editor**](/docs/user-guide/features/interactivity/user-interface/editor/using.md), select the element whose anchors you want to modify\.
...
**Note**
You can [configure the text element](/docs/user-guide/features/interactivity/user-interface/editor/components-text.md) separately\.
