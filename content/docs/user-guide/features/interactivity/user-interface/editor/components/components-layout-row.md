...
+ In the [**UI Editor**](/docs/user-guide/features/interactivity/user-interface/editor/using.md), choose **New**, **Element from Slice Library**, **LayoutRow**\.

**To edit a layout row component**
In the **Properties** pane of the [**UI Editor**](/docs/user-guide/features/interactivity/user-interface/editor/using.md), expand **LayoutRow** and do the following, as appropriate:
****Padding****
...
When you clear this option, the layout row uses the children's layout cell calculated values to determine how much space to give each child based on its contents\. For more information, see [LayoutCell](/docs/user-guide/features/interactivity/user-interface/editor/components-layout-cell.md)\.