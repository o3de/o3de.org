...
title: LayoutGrid
---
# LayoutGrid {#ui-editor-components-layout-grid}
...
+ In the [**UI Editor**](/docs/user-guide/features/interactivity/user-interface/editor/using.md), choose **New**, **Element from Slice Library**, **LayoutGrid**\.

**To edit a layout grid component**
In the **Properties** pane of the [**UI Editor**](/docs/user-guide/features/interactivity/user-interface/editor/using.md), expand **LayoutGrid** and do the following, as appropriate:
****Padding****
