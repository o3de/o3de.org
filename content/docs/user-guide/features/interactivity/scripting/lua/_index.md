...
+ For information on Lumberyard's built\-in Lua editor, see [Lua Editor](/docs/user-guide/features/interactivity/scripting/lua/debugging.md)\.
...
+ For information about the Lumberyard EBus, see [Working with the Event Bus \(EBus\) system](/docs/user-guide/features/engine/ebus)\.