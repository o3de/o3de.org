...
Before starting, you must get a local copy of the [Atom Sample Viewer](https://github.com/o3de/o3de-atom-sampleviewer) repository from GitHub and build it using Visual Studio. Follow the instructions in the [Setting Up Atom Projects](/docs/atom-guide/setup-atom-projects.md) page to get set up. 
