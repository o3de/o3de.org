...
### Metallic 
The **Metallic** properties determine whether a material behaves as a dielectric (non-metal) surface, or as a conductor (metal) surface. The metallic value is usually either completely metal (1) or completely non-metal (0), though in-between values will occur when transitioning between the two using a texture map. 
