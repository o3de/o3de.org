...
In the pass creation process, there are three components involved: `Pass`, `Pass System`, `Pass Template`, and `Pass Request`. When creating passes, the pass system uses the information defined in a pass template to create an instance of a pass. A pass request can be used to tell the pass system to create a pass. This section goes into detail each component's role.
