...
Set up and install Atom on PC, Android, Mac, and iOS platforms. You can begin exploring Atom’s features and capabilities through its built-in BaseViewer application, through the O3DE game engine, or by building from source.

For more information on setting up and installing Atom, see the [Setup and Installation](../setup/installing-atom.md) section of this guide. 
...
* **[Atom core systems](../architecture/_index.md)**: Dive into Atom’s rendering pipeline and learn about the core systems and how they work together. 
