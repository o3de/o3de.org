...
## Update the local Atom project repos

The community is continuing to update the Atom project repositories. Follow these steps to ensure you have the latest updates to the Atom repositories. 
...
4. Use CMake to build the project launcher, O3DE Editor, and Asset Processor. The following command builds using the profile configuration. When specifying the Editor as a build target, the Asset Processor will be built too, since it is a dependency of the Editor.
