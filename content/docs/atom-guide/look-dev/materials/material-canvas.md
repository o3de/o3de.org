...
description: Learn how to use the Material Canvas to create materials in Atom.
toc: true
---

The **Material Canvas** is a standalone application that allows artists to view, edit, and create new materials. This section introduces the Material Canvas and describes the editor layout and its individual panels.

## Quick Start
To get started, launch the Material Canvas and create or edit a material. 

#### Launch the Material Canvas
You can launch the Material Canvas from the **Open 3D Engine (O3DE)** Editor, or as a standalone application:   

- From the O3DE Editor, you can launch Material Canvas in two ways.
  
  - Select **Main Menu > Tools > Material Canvas**.
  
  - From a Material component in the Inspector, select **Edit Material in Material Canvas...** in the hamburger menu of a material assignment slot.

- As a standalone application, launch the executable `<build>\bin\profile\MaterialCanvas.exe`.

#### Create or edit a material
You can create a new material or edit an existing material from the File menu in the Material Canvas, or from the Context menu in the Asset Browser: 

- From the File menu in the Material Canvas:
...
- From the Context menu in the Asset Browser:
  ...
  3. Choose **Open in Material Canvas...** to open the material in the Material Canvas.
...
## Main Menus
At the top of the Material Canvas are the following menus: File, Edit, View, and Help. 
...
### View Menu
The view menu lets you open or close panels and switch to different tabs in the Material Canvas.
