...
| [Vertex Deformation for Vegetation Bending Tutorial](/docs/learning-guide/tutorials/rendering/vegetation-bending-tutorial) | Use the **Atom Renderer** to create a custom material type with custom vertex shaders for vegetation bending. |