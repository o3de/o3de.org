...
{{< note >}}
The Snap package is experimental and may run into issues on some distros. These instructions have been tested on Ubuntu 20.04 and 22.04 LTS. You will need to install all the dependancies in the Linux requirements: https://www.o3de.org/docs/welcome-guide/requirements/#linux
{{< /note >}}
