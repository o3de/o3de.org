...
1. Set the properties for each motion\. Add modifiers to each motion as required\. For information on **Motion** properties and modifiers, see [FBX Settings Motions tab](/docs/userguide/fbx/settings-motions-tab.md)\.
