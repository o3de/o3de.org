...
## Configuring and Loading Localization Data {#localization-configuring}
...
English is the default language for a game project\. To change languages, see [Console Variables](/docs/userguide/localization/initialization#localization-initialization-cvars)\.

### Tag Definition XML {#localization-configuring-tagxml}

The **Tag Definition XML** file groups localized text XML files by tag name\. It must be [loaded in C\+\+ at runtime](/docs/userguide/localization/initialization#localization-initialization-manager), typically at startup\.
