...
1. In the **Parameters** pane, for **Sun Rays Effect**, adjust the [Sun Ray Effects Parameters](/docs/userguide/sky/tod-parameters.md#sun-ray-effects-time-of-day-parameters) as needed\. 
