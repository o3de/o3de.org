...
1. In the **Parameters** pane, for **Night Sky** and **Night Sky Multiplier**, adjust the [Night Sky Parameters](/docs/userguide/sky/tod-parameters.md#night-sky-time-of-day-parameters) and [Night Sky Multiplier Parameters](/docs/userguide/sky/tod-parameters.md#night-sky-multiplier-time-of-day-parameters) as needed\.
