...
![\[Example Script Canvas graph with collision targets.\]](/images/scripting/script-canvas/target.gif)
...
![\[Transform properties for the Projectile entity.\]](/images/scripting/script-canvas/script-canvas-projectile-transform-properties.png)
...
![\[Select the mesh asset for the projectile entity.\]](/images/scripting/script-canvas/pick-static-mesh-window-primitive-sphere.png)
...
![\[Select the Script Canvas graph file for the entity.\]](/images/scripting/script-canvas/script-canvas-pick-script-canvas-window.png)

1. Verify that the **Projectile** entity looks like the following\.  
**Example**    
![\[The components and properties for the Projectile entity.\]](/images/scripting/script-canvas/script-canvas-entity-projectile.png)
...
![\[Get Forward node in Script Canvas.\]](/images/scripting/script-canvas/script-canvas-on-graph-start-get-forward-connection.png)
...
![\[Set Velocity node in Script Canvas.\]](/images/scripting/script-canvas/script-canvas-get-forward-set-velocity-connection.png)

1. To set a lifetime for the projectile, do the following:

   1. In the **Node Palette**, enter **delay** in the search box\.  
![\[Delay node in Script Canvas.\]](/images/scripting/script-canvas/script-canvas-delay-node.png)
...
![\[Connect the On Graph Start node to the Delay node.\]](/images/scripting/script-canvas/script-canvas-delay-node-properties-connections.png)
...
![\[Use the Destroy Game Entity and Descendents node to destroy entities that are generated.\]](/images/scripting/script-canvas/script-canvas-game-entity-destroy-game-entity-descendants-node.png)

   1. From **Delay**, drag the **Out** pin to connect it to the **In** pin of the **Destroy Game Entity and Descendants** node\.  
![\[Connect the Delay node to the Destroy Game Entity and Descendents node.\]](/images/scripting/script-canvas/script-canvas-destroy-gem-entity-descendents-node-properties-connections.png)

   1. Verify that your `projectile.scriptcanvas` graph looks like the following\.  
**Example**    
![\[Example script for the projectile entity in Script Canvas.\]](/images/scripting/script-canvas/script-canvas-projectile-script-example.png)
...
![\[Select the projectile.slice file in the Asset Browser.\]](/images/scripting/script-canvas/script-canvas-asset-browser-projectile-slice-file.png)
...
![\[Set the projectile.slice file as a dynamic slice in the Asset Browser.\]](/images/scripting/script-canvas/script-canvas-projectile-dynamic-slice.png)
...
![\[Select the projectile.slice for the Spawner component.\]](/images/scripting/script-canvas/script-canvas-pick-dynamic-slice-window.png)

1. Verify that the **spawner** entity looks like the following\.  
![\[The components and properties for the spawner entity.\]](/images/scripting/script-canvas/script-canvas-entity-spawner.png)
...
![\[Example inputbindings for the entity.\]](/images/scripting/script-canvas/player-inputbindings-editor-shoot.png)
...
![\[Input Handler node in Script Canvas.\]](/images/scripting/script-canvas/script-canvas-input-handler-node.png)
...
![\[Once node in Script Canvas.\]](/images/scripting/script-canvas/script-canvas-once-node.png)

   1. From **Input Handler**, drag the **Held** pin to connect it to the **In** pin of the **Once** node\.  
![\[Once node in Script Canvas.\]](/images/scripting/script-canvas/script-canvas-input-handler-once-connection.png)
...
![\[Connect the Once node to the Spawn node in Script Canvas.\]](/images/scripting/script-canvas/script-canvas-once-spawn-connection.png)
...
**Example**    
![\[Example script for the spawned entities.\]](/images/scripting/script-canvas/script-canvas-spawn-delay-connection-properties.png)
...
![\[Create an entity named Target.\]](/images/scripting/script-canvas/script-canvas-entity-inspector-name-target.png)
...
![\[Assign a mesh asset to the Target entity.\]](/images/scripting/script-canvas/script-canvas-pick-static-mesh-primitive-cylinder.png)
...
![\[Tag component attached to the Target entity.\]](/images/scripting/script-canvas/script-canvas-tag-component-properties.png)

1. Verify that your **Target** entity appears like the following\.  
**Example**    
![\[Example components attached to the Target entity.\]](/images/scripting/script-canvas/script-canvas-target-entity-component-properties.png)
...
![\[On Collision node in Script Canvas.\]](/images/scripting/script-canvas/script-canvas-physics-on-collision-component.png)
...
![\[Connect the On Collision node to the Set hit variable node in Script Canvas.\]](/images/scripting/script-canvas/script-canvas-set-hit-collision-connections.png)
...
![\[Connect the Set hit node to the Create CRC32 node in Script Canvas.\]](/images/scripting/script-canvas/script-canvas-crc32-set-hit-connection.png)

   1. In the **Node Palette**, enter **tag** in the search box\.

   1. Under **Gameplay**, **Tag**, drag **Has Tag** from the **Node Palette** to the graph\.  
![\[Has Tag node in Script Canvas.\]](/images/scripting/script-canvas/script-canvas-has-tag-node.png)
...
![\[Connect the Get hit variable node to the Has Tag node in Script Canvas.\]](/images/scripting/script-canvas/script-canvas-get-hit-has-tag-connection.png)
...
![\[Connect the Has Tag node in to the If node in Script Canvas.\]](/images/scripting/script-canvas/script-canvas-has-tag-if-nodes-connection.png)
...
1. Do the following to add a destroy node:
   ...
   1. Under **Entity**, **Game Entity**, drag **Destroy Game Entity and Descendants** from the **Node Palette** to the graph\.  
![\[Destroy Game Entity and Descendants node in Script Canvas.\]](/images/scripting/script-canvas/script-canvas-destroy-game-entity-descendants-node.png)
   ...
   1. Verify that your `projectile.scriptcanvas` graph looks like the following\.  
**Example**    
![\[Example Script Canvas graph for the projectile entity.\]](/images/scripting/script-canvas/script-canvas-projectile-script-example-2.png)
