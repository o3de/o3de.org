...
![\[The alignment tools are on the UI Editor's toolbar.\]](/images/game_ui_editor/ui-editor-toolbar-alignment-tool-buttons.png)
...
![\[The selected elements are contained by an imaginary bounding rectangle, which determines how the elements are moved.\]](/images/game_ui_editor/ui-editor-toolbar-alignment-tool-bounding1.png)
...
![\[Align elements vertically by their center.\]](/images/game_ui_editor/ui-editor-toolbar-alignment-tool-bounding2.png)
...
![\[Align elements vertically by their right edges.\]](/images/game_ui_editor/ui-editor-toolbar-alignment-tool-bounding3.png)