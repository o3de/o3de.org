...
1. [ATL Controls Pane](/docs/userguide/audio/atl-editor-atl-controls.md) – Hierarchical view of controls that exist in your project\. The displayed icon designates the type of control\.

1. [Inspector Pane](/docs/userguide/audio/atl-editor-inspector.md) – Properties for the control selected in the **ATL Controls** pane\.

1. [Wwise Controls Pane](/docs/userguide/audio/atl-editor-middleware.md) – Controls created in the audio middleware authoring application, such as Wwise or Wwise LTX Authoring Tool\.
