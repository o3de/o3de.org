...
![\[You can specify an unassigned motion entry to a sparse motion set.\]](/images/actor-animation/animation-editor-sparse-motion-sets.png)
...
![\[Add motion conditions so that some motion states are unassigned.\]](/images/actor-animation/animation-editor-motion-condition.png)
...
![\[Customize state machines based on motion sets.\]](/images/actor-animation/animation-editor-sparse-motion-sets-02.png)