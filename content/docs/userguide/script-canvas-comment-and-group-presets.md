...
![\[Using Script Canvas Node Inspector to customize node comments and node groups.\]](/images/scripting/script-canvas/script-canvas-comment-and-group-presets-1.png)
...
![\[Creating a preset from an existing comment in Script Canvas.\]](/images/scripting/script-canvas/script-canvas-comment-and-group-presets-2.png)

1. In the **Set Preset Name** dialog box, enter a name for the preset, and then click **OK**\.  
![\[Naming a comment or group preset in Script Canvas.\]](/images/scripting/script-canvas/script-canvas-comment-and-group-presets-3.png)
...
![\[Choosing a preset comment\]](/images/scripting/script-canvas/script-canvas-comment-and-group-presets-4.png)
...
![\[Setting a preset as the default in the Script Canvas Presets Editor.\]](/images/scripting/script-canvas/script-canvas-comment-and-group-presets-7.png)
...
![\[Using the Presets Editor in Script Canvas to remove a comment preset.\]](/images/scripting/script-canvas/script-canvas-comment-and-group-presets-8.png)
