...
![\[Example controllable sphere in Script Canvas.\]](/images/scripting/script-canvas/moving.gif)
...
![\[Create an entity for the sphere in Script Canvas.\]](/images/scripting/script-canvas/entity-inspector-name-field-player.png)
...
![\[Select the sphere asset for the Mesh component.\]](/images/scripting/script-canvas/pick-static-mesh-window-primitive-sphere.png)
...
![\[Creating the inputbindings for the Input component.\]](/images/scripting/script-canvas/player-inputbindings-editor-move-x.png)
...
![\[Example player.inputbindings file.\]](/images/scripting/script-canvas/player-inputbindings-editor.png)
...
![\[Example Input Handler node in Script Canvas.\]](/images/scripting/script-canvas/input-handler-node-event-name-move-y.png)
...
![\[Example Input Handler and Print nodes in Script Canvas.\]](/images/scripting/script-canvas/input-handler-log-script-canvas-example.png)
...
![\[Console pane outputs 1 when you press W.\]](/images/scripting/script-canvas/script-canvas-console-test-input-event.png)
...
![\[Example Script Canvas Multiply node.\]](/images/scripting/script-canvas/move-entity-script-canvas-multiply-node.png)
...
![\[Example Script Canvas graph to move a sphere across the y-axis.\]](/images/scripting/script-canvas/move-entity-script-canvas-example.png)
...
![\[Example Script Canvas graph to add movement on the x-axis for the sphere.\]](/images/scripting/script-canvas/script-canvas-selected-nodes-highlight.png)
...
![\[Copy the nodes in the Script Canvas graph to move the sphere up and down and side to side.\]](/images/scripting/script-canvas/script-canvas-selected-nodes-copied.png)
...
![\[Example Multiply and Create From Values nodes in Script Canvas.\]](/images/scripting/script-canvas/script-canvas-create-from-values-node.png)

1. Verify that your `player.scriptcanvas` file graph looks like the following\.  
**Example**    
![\[Example Script Canvas graph to control your sphere movement.\]](/images/scripting/script-canvas/script-canvas-x-axis-movement.png)
