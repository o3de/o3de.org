...
![\[Resource groups details\]](/images/cloud_canvas/cloud-canvas-resource-groups-detail-pane.png)
...
![\[Upload all resources\]](/images/cloud_canvas/cloud-canvas-upload-all-resources.png)
Note the following:   
...
![\[Create deployment\]](/images/cloud_canvas/cloud-canvas-resource-groups-create-deployment.png)
...
![\[New resource group\]](/images/cloud_canvas/cloud-canvas-ui-rm-new-resource-group-w-examples.png)
...
![\[Individual resource group\]](/images/cloud_canvas/cloud-canvas-ui-rm-individual-resource-group.png)
...
![\[Add resource\]](/images/cloud_canvas/cloud-canvas-ui-rm-add-resource-definition-prompt.png)
...
![\[Create resources\]](/images/cloud_canvas/cloud-canvas-rm-create-resources.png)
...
![\[Resource group status\]](/images/cloud_canvas/cloud-canvas-ui-rm-resource-group-detail-pane.png)
...
![\[Upload group resources\]](/images/cloud_canvas/cloud-canvas-rm-upload-group-resources.png)
...
![\[Remove resource group\]](/images/cloud_canvas/cloud-canvas-rm-remove-resource-group-confirmation.png)
...
![\[Delete resources\]](/images/cloud_canvas/cloud-canvas-rm-delete-resources-option.png)
...
![\[Delete group resources\]](/images/cloud_canvas/cloud-canvas-ui-rm-delete-group-resources.png)
