...
![\[Specify whether component is active, inactive, or active in editor mode only.\]](/images/shared-component-entity-inspector-startactive.png)
...
![\[Specify whether component is active, inactive, or active in editor mode only.\]](/images/shared-component-entity-inspector-inactive-example.png)  
**Example Editor only**  

   Editor only entities have an icon that is not shaded and editor only text appears in the viewport\.  
![\[Specify whether component is active, inactive, or active in editor mode only.\]](/images/shared-component-entity-inspector-editor-only-example.png)