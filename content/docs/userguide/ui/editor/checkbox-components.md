...
+ In the [**UI Editor**](/docs/userguide/ui/editor/using.md), choose **New**, **Element from Slice Library**, **Checkbox**\.

**To edit a check box component**  
In the **Properties** pane of the [**UI Editor**](/docs/userguide/ui/editor/using.md), expand **Checkbox** and do the following, as appropriate:    
**Interactable**  
