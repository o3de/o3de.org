...
Similar to the **LayoutColumn** component, the **LayoutRow** component has an **Ignore Default Cell** property\. For more information, see [LayoutColumn](/docs/userguide/ui/editor/components-layout-column.md)\.

![\[Image NOT FOUND\]](/images/userguide/game_ui_editor/ui-editor-components-layout-row.png)
...
+ In the [**UI Editor**](/docs/userguide/ui/editor/using.md), choose **New**, **Element from Slice Library**, **LayoutRow**\.

**To edit a layout row component**
In the **Properties** pane of the [**UI Editor**](/docs/userguide/ui/editor/using.md), expand **LayoutRow** and do the following, as appropriate:
****Padding****
...
****Ignore Default Cell****
Selected by default, this property causes the layout row to give each child an equal amount of space regardless of their contents \(unless the child has a [**LayoutCell**](/docs/userguide/ui/editor/components-layout-cell.md) component\)\. The layout row ignores the layout cell's content\-based default calculations\.
When you clear this option, the layout row uses the children's layout cell calculated values to determine how much space to give each child based on its contents\. For more information, see [LayoutCell](/docs/userguide/ui/editor/components-layout-cell.md)\.