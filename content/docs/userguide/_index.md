...
-----
## Contents
+ [What is Lumberyard?](/docs/userguide/lumberyard-intro.md)
   + [Lumberyard Systems](/docs/userguide/lumberyard-systems.md)
   + [Supported platforms](/docs/userguide/lumberyard-supported-platforms.md)
   ...
   + [Lumberyard Programming Concepts and Resources](/docs/userguide/lumberyard-programming-concepts.md)
   ...
   + [Lumberyard Editors and Tools](/docs/userguide/lumberyard-tools.md)
   + [Lumberyard Asset File Types](/docs/userguide/lumberyard-file-types.md)
   + [Lumberyard Blog, Forums, and Feedback](/docs/userguide/lumberyard-blog-forums-feedback.md)
   + [Key Lumberyard Terminology](/docs/userguide/lumberyard-terms.md)
+ [Working with Lumberyard projects](/docs/userguide/lumberyard-projects-intro.md)
   ...
   + [Building Lumberyard projects](/docs/userguide/game-build-intro.md)
      + [Game Build Types in Amazon Lumberyard](/docs/userguide/game-build-types.md)
      ...
      + [Adding Custom Game Icons](/docs/userguide/game-build-custom-game-icons.md)
...
+ [Using Lumberyard Editor](/docs/userguide/editor/intro.md)
   ...
   + [Automating the Lumberyard Editor with the Python Editor Bindings gem](/docs/userguide/editor-automation.md)
      + [Python Editor Bindings gem examples](/docs/userguide/editor-automation-examples.md)
...
+ [Working with assets in Lumberyard](/docs/userguide/assets/intro.md)
   + [Working with the Asset Pipeline and asset files](/docs/userguide/assets/intro.md)
      ...
      + [Programming the Lumberyard AZCore Runtime Asset System](/docs/userguide/assets/asset-system-programming.md)
         ...
         + [Creating a Custom Asset Builder](/docs/userguide/asset-builder-custom.md)
         ...
         + [Raw File Access in Lumberyard](/docs/userguide/file-access-direct.md)
...
+ [Working with component entities](/docs/userguide/components/intro.md)
   ...
   + [Reflecting Lumberyard Classes, Methods, and EBus Interfaces](/docs/userguide/components/entity-system-reflection-intro.md)
      + [Serialization Context](/docs/userguide/components/entity-system-reflection-serialization-context.md)
         ...
         + [Avoiding Data Loss when Serializing Component Data](/docs/userguide/best-practices-for-component-data-serialization.md)
...
+ [Add modular features and assets with Gems](/docs/userguide/gems/builtin/s.md)
   ...
   + [Gems Available in Lumberyard](/docs/userguide/gems/ref.md)
      ...
      + [EMotion FX Animation Gem](/docs/userguide/gems/builtin/emotionfx-animation.md)
         + [EMotion FX transition guide version 1.25](/docs/userguide/emfx-1.25-transition-guide.md)
      ...
      + [Lightning Arc Gem](/docs/userguide/gems/builtin/lightning-arc.md)
         + [Using the LightingArc Sample](/docs/userguide/gems-lightning-arc-sample.md)
...
+ [Create levels in Lumberyard](/docs/userguide/levels-intro.md)
...
+ [Actor and effects animation in Lumberyard](/docs/userguide/animation-intro.md)
...
+ [Graphics and Rendering in Lumberyard](/docs/userguide/rendering-intro.md)
...
+ [Programming in Lumberyard](/docs/userguide/programming-intro.md)
   + [Working with Amazon Lumberyard systems APIs](/docs/userguide/systems-intro.md)
   ...
   + [Input in Amazon Lumberyard](/docs/userguide/input-intro.md)
   ...
   + [Lumberyard UI 2.0 Developer Documentation](/docs/userguide/ui20.md)
      ...
      + [Interactive Components](/docs/userguide/ui/editor/components-interactive.md)
         + [Properties for Interactive Components](/docs/userguide/ui/editor/components-interactive-properties.md)
            ...
            + [Navigation](/docs/userguide/ui/editor/components-interactive-properties-navigation.md)
               ...
               + [Interactive Element Controls](/docs/userguide/interactive-control.md)
...
+ [Platform development in Lumberyard](/docs/userguide/platform-development-intro.md)
...
+ [Legal](/docs/userguide/legal-intro.md)
...
+ [Documentation Archive](/docs/userguide/lumberyard-documentation-archive.md)
+ [](ly-glos-chap.md)
