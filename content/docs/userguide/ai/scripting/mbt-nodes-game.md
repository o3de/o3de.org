...
### Example {#ai-scripting-mbt-nodes-game-inflateagentcollisionradiususingphysicstrick-example}
...
### Parameters {#ai-scripting-mbt-nodes-game-scorcherdeploy-parameters}
