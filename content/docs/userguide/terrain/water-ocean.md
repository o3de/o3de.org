...
When you create a new level, Lumberyard creates an ocean by default, complete with waves and reflections\. The ocean uses the [Water Shader](/docs/userguide/shaders/water.md)\. You can change the ocean's various properties and effects\.
