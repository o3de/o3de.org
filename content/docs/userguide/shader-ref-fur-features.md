...
![\[Example anisotropic highlights for fur rendering.\]](/images/shaders/shader-ref-fur-5.png)
...
![\[Example fur shader reference for non-furry areas.\]](/images/shader-ref-fur-6.png)
...
![\[Example of subsurface scattering for fur rendering.\]](/images/shaders/shader-ref-fur-7.png)
...
![\[Example furry sphere without shadowing, fur blend color, and blendlayer.\]](/images/shaders/shader-ref-fur-7a.png)

You can adjust the interpolation speed by modifying the material parameter **Fur Self Shadowing Bias**\.

![\[Example adjusting interpolation speed with the Fur Self Shadowing Bias parameter.\]](/images/shaders/shader-ref-fur-8.png)
...
![\[Example fur in shadows.\]](/images/shaders/shader-ref-fur-9.png)
