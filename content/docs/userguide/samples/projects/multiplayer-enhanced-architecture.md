...
---
# Multiplayer Sample Gameplay Architecture {#sample-project-multiplayer-enhanced-architecture}
...
## Principal Entities in the Multiplayer Sample {#sample-project-multiplayer-enhanced-architecture-entities}
...
### Game Manager {#sample-project-multiplayer-enhanced-architecture-game-manager}
...
### Score Attack Game Mode {#sample-project-multiplayer-enhanced-architecture-score-attack-game-mode}
...
### Asteroid Manager {#sample-project-multiplayer-enhanced-architecture-asteroid-manager}
...
### Collectible Manager {#sample-project-multiplayer-enhanced-architecture-collectible-manager}
...
### Spawn Manager {#sample-project-multiplayer-enhanced-architecture-spawn-manager}
...
## Multiplayer Sample Network Architecture {#sample-project-multiplayer-enhanced-architecture-network}
