...
![\[Example that shows how the collider for the second spine joint intersects with the first or third spine joint\]](/images/userguide/actor-animation/ragdoll-collider-spine-joints-example.png)
