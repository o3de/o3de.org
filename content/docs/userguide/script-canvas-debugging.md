...
![\[Choose Tools, Debugging.\]](/images/scripting/script-canvas/script-canvas-debugging-1.png)
...
![\[Choosing the debug target.\]](/images/scripting/script-canvas/script-canvas-debugging-2.png)
...
![\[Entities with Script Canvas graphs.\]](/images/scripting/script-canvas/script-canvas-debugging-3.png)
**Note**  
...
![\[Graphs that are attached to entities.\]](/images/scripting/script-canvas/script-canvas-debugging-4.png)

1. On the **Entities** tab or **Graphs** tab, select the check boxes for the entities or graphs that you want to debug\.  
![\[Selecting entities to debug.\]](/images/scripting/script-canvas/script-canvas-debugging-5.png)

1. To capture all instances of a selected graph, select **All Graph Instances**\.  
![\[Selecting all instances of a graph.\]](/images/scripting/script-canvas/script-canvas-debugging-6.png)
...
![\[The Auto Capture option enabled.\]](/images/scripting/script-canvas/script-canvas-debugging-7.png)
...
![\[The Live Updates option enabled.\]](/images/scripting/script-canvas/script-canvas-debugging-8.png)
...
![\[The Script Canvas debugger Capture button.\]](/images/scripting/script-canvas/script-canvas-debugging-9.png)
**Note**  
...
![\[Data being captured in the Script Canvas debugger.\]](/images/scripting/script-canvas/script-canvas-debugging-10.png)
...
![\[Captured data in the Script Canvas debugger.\]](/images/scripting/script-canvas/script-canvas-debugging-11.png)
...
![\[Choosing a debugger line to show the corresponding node on a Script Canvas graph.\]](/images/scripting/script-canvas/script-canvas-debugging-12.png)
...
![\[Expanding a log message to reveal its data.\]](/images/scripting/script-canvas/script-canvas-debugging-13.png)
**Note**  
...
![\[Using search to find specific nodes in the Script Canvas debugger.\]](/images/scripting/script-canvas/script-canvas-debugging-16.png)
...
![\[Choosing a launcher debug target.\]](/images/scripting/script-canvas/script-canvas-debugging-2.png)
