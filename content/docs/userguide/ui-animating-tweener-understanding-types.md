...
![\[Linear easing function\]](/images/ui-animating-tweener-linear.png)
...
![\[Quadratic easing in, out, and in-out functions\]](/images/ui-animating-tweener-quad.png)
...
![\[Cubic easing in, out, and in-out functions\]](/images/ui-animating-tweener-cubic.png)
...
![\[Quartic easing in, out, and in-out functions\]](/images/ui-animating-tweener-quart.png)
...
![\[Quintic easing in, out, and in-out functions\]](/images/ui-animating-tweener-quint.png)
...
![\[Sinusoidal easing in, out, and in-out functions\]](/images/ui-animating-tweener-sine.png)

**Exponential**  
Similar to cubic\.  
The following graphs show exponential ease in, exponential ease out, and exponential ease in\-out functions\.  

![\[Exponential easing in, out, and in-out functions\]](/images/ui-animating-tweener-cubic.png)
...
![\[Circular easing in, out, and in-out functions\]](/images/ui-animating-tweener-circ.png)
...
![\[Elastic easing in, out, and in-out functions\]](/images/ui-animating-tweener-elastic.png)
...
![\[Back easing in, out, and in-out functions\]](/images/ui-animating-tweener-back.png)
...
![\[Bounce easing in, out, and in-out functions\]](/images/ui-animating-tweener-bounce.png)