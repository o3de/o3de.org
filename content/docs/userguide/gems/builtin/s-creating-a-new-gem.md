...
You can create a new, empty gem using either the [Project Configurator](/docs/userguide/gems-system-gems-creating-a-new-gem-projconf.md) or the [command line](/docs/userguide/gems-system-gems-creating-a-new-gem-cmdline.md)\. When you create a new gem, Lumberyard automatically creates a directory structure for your gem in the `\dev\Gems\` directory\. It also adds the special gem files and directories needed to function as a gem\.

**Topics**
+ [Creating a Gem with the Project Configurator](/docs/userguide/gems-system-gems-creating-a-new-gem-projconf.md)
+ [Creating a Gem from the Command Line](/docs/userguide/gems-system-gems-creating-a-new-gem-cmdline.md)