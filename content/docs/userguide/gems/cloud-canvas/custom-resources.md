...
### Metadata: Linking a User Pool to an Identity Pool {#cloud-canvas-custom-resources-cognito-user-pool-metadata}
...
### Input Properties {#cloud-canvas-custom-resources-resource-group-configuration-input-properties}
+ `ConfigurationBucket`
