...
## Prerequisites {#cloud-canvas-cloud-gem-dc-testing-prerequisites}
...
## Data Preparation {#cloud-canvas-cloud-gem-dc-testing-data-preparation}
...
## Running the Test {#cloud-canvas-cloud-gem-dc-testing-run-the-test}
...
## Diagnosing Failures {#cloud-canvas-cloud-gem-dc-testing-diagnosing-failures}

When diagnosing a failure, you must determine how far your updated data went in the processing chain\.

### Check the \.pak File for Upload {#cloud-canvas-cloud-gem-dc-testing-check-the-pak-file-for-upload}
...
### Check the Downloaded \.pak File {#cloud-canvas-cloud-gem-dc-testing-check-the-downloaded-pak-file}
...
## Test Implementation Details {#cloud-canvas-cloud-gem-dc-testing-test-implementation-details}
