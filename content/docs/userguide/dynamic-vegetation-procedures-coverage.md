...
![\[Create an entity to cover your level.\]](/images/vegetation/dynamic/expanding-vegetation-coverage-1.png)
...
![\[Specify the WorldBox entity for the Vegetation Reference Shape component.\]](/images/vegetation/dynamic/expanding-vegetation-coverage-2.png)  
**Example**  

   The vegetation appears for the entire level\. As you move through the level, the vegetation dynamically appears\.  
![\[Specify a world box entity so that vegetation appears for the entire level.\]](/images/vegetation/dynamic/expanding-vegetation-coverage-3.png)