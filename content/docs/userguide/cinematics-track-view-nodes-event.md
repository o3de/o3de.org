...
![\[Creating track event nodes in a sequence.\]](/images/cinematics/cinematics-track-view-editor-track-event-nodes.png)

**To create a Track Event**

1. In the node browser, right\-click and choose **Edit Events**\. This opens the **Track View Events** window\.  
![\[Creating a track event for a sequence.\]](/images/cinematics/cinematics-track-view-editor-track-event-nodes-2.png)
...
![\[Enter a name for a track event in your sequence.\]](/images/cinematics/cinematics-track-view-editor-track-event-nodes-3.png)
