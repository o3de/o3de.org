...
![\[The Script Events category in the Script Canvas Node Palette.\]](/images/script-canvas-script-events-4.png)
...
![\[Choose Send method_name in the context menu.\]](/images/script-canvas-script-events-5.png)

   A method send node is added to the graph\.  
![\[A send node added to a Script Canvas graph.\]](/images/script-canvas-script-events-6.png)
...
![\[Choose Receive method_name in the context menu.\]](/images/script-canvas-script-events-7.png)

   An event handler method node is added to the graph\.  
![\[A receive node added to a Script Canvas graph.\]](/images/script-canvas-script-events-8.png)
