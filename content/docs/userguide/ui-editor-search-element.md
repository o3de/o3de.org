...
![\[The UI Editor's Find Element tool.\]](/images/game_ui_editor/ui-editor-search-element-tool.png)
...
![\[To find UI elements by name, enter the name in the search box.\]](/images/game_ui_editor/ui-editor-search-element-name.png)
...
![\[To find UI elements by components, click the filter button and select a component.\]](/images/game_ui_editor/ui-editor-search-element-component.png)
...
![\[The parent of a child element that meets search criteria appears in gray text.\]](/images/game_ui_editor/ui-editor-search-element-gray.png)
...
![\[Choose Select in Hierarchy to transfer your selections to the Hierarchy panel.\]](/images/game_ui_editor/ui-editor-search-element-hierarchy.png)