...
![\[Click Advanced Settings in the Project Configurator.\]](/images/modules/az-module-system-entities-advanced-settings.png)
...
![\[Added required components in the System Entity Editor.\]](/images/modules/az-module-system-entities-added-required-components.png)
**Note**  
...
![\[Choose a project in the System Entity Editor\]](/images/modules/az-module-system-entities-choose-project.png)
...
![\[Choose the Game system entity or the Editor system entity\]](/images/modules/az-module-system-entities-choose-game-or-editor.png)

   The **System Entity** tab lists any components that have already been added\.  
![\[Added components for the system entity.\]](/images/modules/az-module-system-entities-tab-added-components.png)

1. To add a component to the system entity, click **Add Component**\.  
![\[Click Add Component to add a component to the system entity\]](/images/modules/az-module-system-entities-add-component.png)

1. To see more information about a component before you add it, pause your pointer over the name\.  
![\[For a brief description of the component, see its tooltip\]](/images/modules/az-module-system-entities-add-component-tool-tip.png)
...
![\[Right-click a component to delete, disable, or move it.\]](/images/modules/az-module-system-entities-context-menu.png)

1. To configure system memory options, choose the **Memory Settings** tab\.  
![\[System memory settings in the System Entity Editor,\]](/images/modules/az-module-system-entities-system-memory-settings.png)
