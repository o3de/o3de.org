...
![\[Creating an array variable in Script Canvas.\]](/images/scripting/script-canvas/script-canvas-containers-1.png)

1. Enter information to create your array, and then click **Create**\.  
![\[Enter information to create your array.\]](/images/shared-script-canvas-containers-2.png)
...
![\[Array variable pinned to the variable list in Variable Manager.\]](/images/scripting/script-canvas/script-canvas-containers-3.png)
...
![\[Array data pins color-coded by data type.\]](/images/scripting/script-canvas/script-canvas-containers-4.png)
...
![\[Container node operations.\]](/images/scripting/script-canvas/script-canvas-containers-5.png)
...
![\[For Each node connection pins.\]](/images/scripting/script-canvas/script-canvas-containers-6.png)
...
![\[Connecting a Get container node to a container operation node.\]](/images/scripting/script-canvas/script-canvas-containers-7.png)
...
![\[Example of automatic data pin typing.\]](/images/scripting/script-canvas/script-canvas-containers-8.png)
...
![\[Chained array operation nodes.\]](/images/scripting/script-canvas/script-canvas-containers-9.png)
...
![\[A map variable in the Script Canvas Variable Manager.\]](/images/scripting/script-canvas/script-canvas-containers-10.png)
...
![\[Creating a map variable in Script Canvas.\]](/images/scripting/script-canvas/script-canvas-containers-11.png)

1. Enter information to create your map, and then click **Create**\.  
![\[Enter information to create a key-value pair map.\]](/images/shared-script-canvas-containers-12.png)
...
![\[A map variable pinned to the variable list in the Variable Manager.\]](/images/scripting/script-canvas/script-canvas-containers-13.png)
...
![\[Dual-color map data pin icons.\]](/images/scripting/script-canvas/script-canvas-containers-14.png)
...
![\[Container operations for maps.\]](/images/scripting/script-canvas/script-canvas-containers-15.png)

As with arrays, maps provide a data output pin that you can use to chain operations on the same map\.

![\[Chained map operations.\]](/images/scripting/script-canvas/script-canvas-containers-16.png)