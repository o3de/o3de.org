...
**Note**  
 Lumberyard's PhysX system does not interact with [Physics \(Legacy\)](/docs/userguide/components/components.md#component-entity-physics-legacy) component entities or the legacy [Physics](https://docs.aws.amazon.com/lumberyard/latest/legacyreference/physics-intro.html)\.
...
For more information, see [Configuring the PhysX System](/docs/userguide/nvidia/physx/configuration.md)\.
...
For more information, see [Physics materials](/docs/userguide/nvidia/physx/materials.md)\.
