...
![\[Search and view assets in your game project with the Asset Browser.\]](/images/asset_browser_preview.png)
...
![\[A WombearActor.fbx source file with two products.\]](/images/asset-browser-intro-1.png)

Files that are unprocessed or not usable in Lumberyard Editor appear gray\.

![\[Ignored or unprocessed files are grayed out in the Asset Browser.\]](/images/asset-browser-grayed-out-files.png)
...
![\[Dragging an asset from the Asset Browser into the viewport automatically creates an entity and assigns a Mesh asset.\]](/images/asset-browser-intro-2.png)
...
![\[Animation showing a boulder mesh asset dragged into the Entity Inspector while three empty entities are selected in the Entity Outliner. Three boulders appear in the viewport.\]](/images/asset-browser-intro-4.gif)
...
![\[Animation showing a material dragged from the Asset Browser into the Entity Inspector. The material is dropped onto the Mesh component's Material override field.\]](/images/asset-browser-intro-3.gif)
...
![\[Right-click context menu for assets in the Asset Browser\]](/images/asset-browser-intro-right-click-context.png)
...
![\[Right-click context menu for an .fbx file in the Asset Browser.\]](/images/asset-browser-intro-right-click-context-fbx-tool.png)
...
![\[Slice Relationship View dialog box.\]](/images/slice-relationship-view.png)
...
![\[Right-click context menu in the Asset Browser with source control enabled.\]](/images/asset-browser-intro-right-click-context-1.png)
...
![\[Right-click the context menu in the viewport to locate a slice in the Asset Browser .\]](/images/asset-browser-intro-viewport.png)
...
![\[Filter assets by type in the Asset Browser.\]](/images/asset-browser-filter-by-types.png)
...
![\[Type search terms into the Asset Browser's search bar.\]](/images/asset-browser-intro-filtering-1.png)
