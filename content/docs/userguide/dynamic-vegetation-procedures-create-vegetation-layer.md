...
![\[Create an entity and name it BasicCoverage.\]](/images/vegetation/dynamic/create-vegetation-layer-basic-coverage.png)

1. [Add](component-working-adding.md) the **Vegetation Layer Spawner** component to your entity\.  
![\[Add the Vegetation Layer Spawner component to your entity.\]](/images/vegetation/dynamic/create-vegetation-layer-layer-spawner.png)
...
![\[Choose the Vegetation Reference Shape for your Vegetation Layer Spawner.\]](/images/vegetation/dynamic/create-vegetation-layer-add-shape.png)
...
![\[Adjust your shape to cover a sufficient area and intersect with the ground.\]](/images/vegetation/dynamic/create-vegetation-layer-adjust-shape.png)
...
![\[On the Vegetation Layer Spawner, click Add Component and select Vegetation Asset List.\]](/images/vegetation/dynamic/create-vegetation-layer-asset-list.png)

1. In the **Vegetation Asset List** component, next to **Mesh Asset**, click **Browse \(\.\.\.\)**\.  
![\[Click Browse (…) to select a Mesh Asset.\]](/images/vegetation/dynamic/create-vegetation-layer-browse.png)

1. In the **Search** bar, enter **grass** and select one of the grass assets in the results\.  
![\[Click Browse (…) to select a Mesh Asset.\]](/images/vegetation/dynamic/create-vegetation-layer-asset-grass.png)

   You should have a uniform grassy field with the grass in a grid formation\.  
![\[After selecting your grass asset, you have a grassy field with a grid-like appearance.\]](/images/vegetation/dynamic/create-vegetation-layer-grass-grid.png)