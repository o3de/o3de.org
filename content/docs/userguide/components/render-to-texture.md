...
|  **Alpha Mode**  |  You can specify the following values: [\[See the AWS documentation website for more details\]](/docs/userguide/components/render-to-texture) [\[See the AWS documentation website for more details\]](/docs/userguide/components/render-to-texture)  |
...
|  **GSM LODs**  |  Number of global shadow map levels of detail \([LOD](/docs/userguide/ly-glos-chap#lod)\) to use for the render to texture scene\. A value of `-1` will use the current settings for the `e_GsmLodsNum` console variable\.  |
...
|  **Antialiasing Mode**  |  You can specify the following values: [\[See the AWS documentation website for more details\]](/docs/userguide/components/render-to-texture)  |
