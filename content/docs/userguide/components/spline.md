...
| Spline Type |  Interpolation type to use between vertices\. The component supports the following spline types: [\[See the AWS documentation website for more details\]](/docs/userguide/components/spline)  |
