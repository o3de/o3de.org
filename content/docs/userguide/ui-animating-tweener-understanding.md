...
![\[Ball with bouncing tweener from off-screen to the bottom of the UI screen\]](/images/ui-animating-tweener.gif)
...
![\[Linear tweener for opacity (transparent to opaque) and bouncing tweener for scale (small to large)\]](/images/ui-animating-tweener-1.gif)
