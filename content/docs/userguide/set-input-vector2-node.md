...
![\[SetInputVector2 sets the Vector2 value for a procedural material input parameter.\]](/images/scripting/script-canvas/scriptcanvasnodes/script-canvas-set-input-vector2-node.png)
