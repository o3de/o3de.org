...
![\[Choose File, New Function in the Script Canvas editor to start a new Script Canvas function.\]](/images/scripting/script-canvas/script-canvas-function-file-new.png)
...
![\[Use the function create button as an alternate method for creating a new Script Canvas function.\]](/images/scripting/script-canvas/script-canvas-function-quick-create.png)
...
![\[Create an entry or exit point for a Script Canvas function by right-clicking an execution slot.\]](/images/scripting/script-canvas/script-canvas-function-expose-input.gif)
...
![\[Create function data parameters with variables in the Variable Manager.\]](/images/scripting/script-canvas/script-canvas-function-create-parameter.gif)
...
![\[Drag and drop functions from the Node Palette, under the Global Functions category, onto your graph.\]](/images/scripting/script-canvas/script-canvas-function-use-node.gif)
...
![\[After completing the steps in this example, you should end up with a linear interpolation function.\]](/images/scripting/script-canvas/script-canvas-function-linear-interpolation.png)
...
![\[When a function is used in a Script Canvas graph, it appears as a node, using the function's filename as the node name.\]](/images/scripting/script-canvas/script-canvas-function-linear-interpolation-node.png)