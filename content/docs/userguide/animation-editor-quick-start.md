...
![\[Import the JackBind_ZUp.fbx file into the Animation Editor.\]](/images/actor-animation/animationeditorquickstart/animation-editor-quick-start-jack-idle.png)
...
![\[Create a motion set and add motion files in the Animation Editor.\]](/images/actor-animation/animationeditorquickstart/animation-editor-quick-start-motion-set.png)
...
![\[Create a motion node in the animation graph.\]](/images/actor-animation/animationeditorquickstart/animation-editor-quick-start-anim-graph-node.png)
...
![\[Connect the motion and blend tree nodes in the animation graph.\]](/images/actor-animation/animationeditorquickstart/animation-editor-quick-start-motion-blend-tree-nodes.png)
...
![\[Add parameter conditions to specify when the character starts moving.\]](/images/actor-animation/animationeditorquickstart/animation-editor-quick-start-add-condition.png)
...
![\[Add parameter conditions to specify when the character stops moving.\]](/images/actor-animation/animationeditorquickstart/animation-editor-quick-start-add-condition-02.png)
...
![\[Add the walk motion file to the Motion1 node.\]](/images/actor-animation/animationeditorquickstart/animation-editor-quick-start-motion-node-walk.png)
...
![\[Add the run motion file to the Motion2 node.\]](/images/actor-animation/animationeditorquickstart/animation-editor-quick-start-motion-node-run.png)
...
![\[Create your blend tree in the animation graph.\]](/images/actor-animation/animationeditorquickstart/animation-editor-quick-start-blend-tree-node.png)
...
1. For the **Smoothing0** node, select the **Result** output box and drag the connector to the **Weight** input box of the **BlendTwo0** node\.
   ...
   Your blend tree should look like the following:  
![\[Create a blend tree for your animation graph.\]](/images/actor-animation/animationeditorquickstart/animation-graph-quick-start-blend-tree-final.gif)
...
![\[Animate Jack the robot in the Animation Editor.\]](/images/actor-animation/animationeditorquickstart/animation-editor-quick-start-jack-running.gif)