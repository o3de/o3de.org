...
![\[Click Upload resources in Cloud Canvas Resource Manager\]](/images/cloud_canvas/cloud-canvas-cloud-gem-defect-reporter-cgp-jira-1.png)
...
![\[Click Jira Credentials in the navigation pane of the Cloud Gem Portal.\]](/images/cloud_canvas/cloud-canvas-cloud-gem-defect-reporter-cgp-jira-2.png)
...
![\[Click Defect Reporter in the navigation pane of the Cloud Gem Portal\]](/images/cloud_canvas/cloud-canvas-cloud-gem-defect-reporter-cgp-jira-3.png)

   The **Jira Integration** tab now appears in the Cloud Gem Portal\.  
![\[Jira Integration tab added to the Cloud Gem Portal.\]](/images/cloud_canvas/cloud-canvas-cloud-gem-defect-reporter-cgp-jira-4.png)
...
![\[The Jira Integration Settings section of the Jira Integration tab in the Cloud Gem Portal\]](/images/cloud_canvas/cloud-canvas-cloud-gem-defect-reporter-cgp-jira-5.png)
...
![\[Choose a Jira project\]](/images/cloud_canvas/cloud-canvas-cloud-gem-defect-reporter-cgp-jira-6.png)
...
![\[Choose a default Jira issue type\]](/images/cloud_canvas/cloud-canvas-cloud-gem-defect-reporter-cgp-jira-7.png)
...
![\[The Field Mappings section of the Jira Integration tab\]](/images/cloud_canvas/cloud-canvas-cloud-gem-defect-reporter-cgp-jira-8.png)
...
![\[Choosing a default game event attribute to map to a Jira field.\]](/images/cloud_canvas/cloud-canvas-cloud-gem-defect-reporter-cgp-jira-9.png)
...
![\[Click the plus icon to add multiple instances to a field\]](/images/cloud_canvas/cloud-canvas-cloud-gem-defect-reporter-cgp-jira-10.png)

1. When you are finished, click **Save Settings**\.  
![\[Click Save Settings for Jira integration and field mappings\]](/images/cloud_canvas/cloud-canvas-cloud-gem-defect-reporter-cgp-jira-11.png)
...
![\[Select one or more defect reports on the Overview tab of the Cloud Gem Portal.\]](/images/cloud_canvas/cloud-canvas-cloud-gem-defect-reporter-cgp-jira-12.png)

1. Choose **Bulk Actions**, and then click **Create Jira Issue\(s\)**\.  
![\[Click Create Jira Issue(s)\]](/images/cloud_canvas/cloud-canvas-cloud-gem-defect-reporter-cgp-jira-13.png)
...
![\[Choose group or individual Jira ticket creation\]](/images/cloud_canvas/cloud-canvas-cloud-gem-defect-reporter-cgp-jira-14.png)

1. In the **Create Jira Ticket\(s\)** dialog box, enter the information for the Jira ticket\.  
![\[Entering values for Jira fields\]](/images/cloud_canvas/cloud-canvas-cloud-gem-defect-reporter-cgp-jira-15.png)
...
![\[Choosing a game event attribute to map to a Jira field\]](/images/cloud_canvas/cloud-canvas-cloud-gem-defect-reporter-cgp-jira-16.png)
...
![\[Click the link to open the Jira Integration tab\]](/images/cloud_canvas/cloud-canvas-cloud-gem-defect-reporter-cgp-jira-17.png)
**Note**  
...
![\[Click Create Jira Issue\]](/images/cloud_canvas/cloud-canvas-cloud-gem-defect-reporter-cgp-jira-17a.png)

1. In the **Create Jira Ticket** dialog box, enter the information for the ticket\.  
![\[Click Create Jira Issue\]](/images/cloud_canvas/cloud-canvas-cloud-gem-defect-reporter-cgp-jira-17b.png)
...
![\[Click View Jira Issue\]](/images/cloud_canvas/cloud-canvas-cloud-gem-defect-reporter-cgp-jira-17c.png)
   + In the **Report Information** section, click the **Jira Issue** number\.  
![\[Click the number next to Jira Issue\]](/images/cloud_canvas/cloud-canvas-cloud-gem-defect-reporter-cgp-jira-17d.png)
**Note**  
...
![\[Example game attribute value mapped to a field in a Jira ticket\]](/images/cloud_canvas/cloud-canvas-cloud-gem-defect-reporter-cgp-jira-18.png)