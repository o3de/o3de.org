...
![\[Dynamic Content Manager\]](/images/cloud_canvas/cloud-canvas-cloud-gem-dc-manager-1.png)

1. In **Dynamic Content Manager**, click **Create a new manifest**\.  
![\[Create a manifest\]](/images/cloud_canvas/cloud-canvas-cloud-gem-dc-manager-2-create-manifest.png)
...
![\[Add files\]](/images/cloud_canvas/cloud-canvas-cloud-gem-dc-manager-3-post-manifest-create.png)

   Click **Add Files** or **Add Folder** and choose one of the target operating systems\.  
![\[Select OS\]](/images/cloud_canvas/cloud-canvas-cloud-gem-dc-manager-3-platform-menu.png)

1. In the file browser, choose the files that you want to add to the manifest\.  
![\[Choose files for the manifest\]](/images/cloud_canvas/cloud-canvas-cloud-gem-dc-manager-4.png)
...
![\[Operating system not supported\]](/images/cloud_canvas/cloud-canvas-cloud-gem-dc-manager-4-platform-warning.png)
...
![\[Selected files not in asset cache\]](/images/cloud_canvas/cloud-canvas-cloud-gem-dc-manager-4-asset-cache-warning.png)
...
![\[Create a new package\]](/images/cloud_canvas/cloud-canvas-cloud-gem-dc-manager-5-file-selected.png)
...
![\[New package name\]](/images/cloud_canvas/cloud-canvas-cloud-gem-dc-manager-create-package.png)

1. The new package appears in the right pane of **Dynamic Content Manager**\. You can sort the packages by column\.  
![\[New package created\]](/images/cloud_canvas/cloud-canvas-cloud-gem-dc-manager-7-package-created.png)
...
![\[Add files from the manifest to the package\]](/images/cloud_canvas/cloud-canvas-cloud-gem-dc-manager-8-files-added-to-package.png)
...
![\[Incompatible file alert\]](/images/cloud_canvas/cloud-canvas-cloud-gem-dc-manager-8-incompatible-platform-files-dialog.png)
...
![\[Change target OSes\]](/images/cloud_canvas/cloud-canvas-cloud-gem-dc-manager-platform-setting.png)
...
![\[Choose target operating systems and devices\]](/images/cloud_canvas/cloud-canvas-cloud-gem-dc-manager-change-target-platforms.png)
...
![\[OS-specific files\]](/images/cloud_canvas/cloud-canvas-cloud-gem-dc-manager-platform-specific-files.png)

1. When you are ready, click **Upload Packages**\.

1. \(Optional\) To sign your packages, select **Sign packages with security key**\.  
![\[Sign packages with security key\]](/images/cloud_canvas/cloud-canvas-cloud-gem-dc-manager-sign-packages.png)

1.  If you haven't yet generated key pairs, click **Next** to generate a new key pair, and then click **Continue**\.  
![\[Generate new keys\]](/images/cloud_canvas/cloud-canvas-cloud-gem-dc-manager-generate-new-keys.png)

   You can also use the file menu to generate a new key pair at any time\.  
![\[Generate a key pair from the file menu\]](/images/cloud_canvas/cloud-canvas-cloud-gem-dc-manager-file-menu-generate-new-keys.png)
...
![\[Upload\]](/images/cloud_canvas/cloud-canvas-cloud-gem-dc-manager-upload-key-exists.png)

   The status bar of the main window shows upload process messages\.  
![\[Upload process messages\]](/images/cloud_canvas/cloud-canvas-cloud-gem-dc-manager-upload-process.png)

   An animation in the **S3 Status** column indicates the package that is being uploaded\.  
![\[Upload process indicator\]](/images/cloud_canvas/cloud-canvas-cloud-gem-dc-manager-upload-process-animation.png)
