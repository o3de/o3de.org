---
description: ' Reduce the amount of network traffic generated by datasets in Amazon Lumberyard. '
title: Using Delta Compression in Lumberyard Networking
---
# Using Delta Compression in Lumberyard Networking {#network-delta-compression}
...
## Delta Compression Overview {#network-delta-compression-delta-compression-overview}
...
### Delta Range {#network-delta-compression-delta-range}
...
### AZ::Vector3 Values {#network-delta-compression-azvector3-values}
