...
![\[Animation graph without hub nodes.\]](/images/actor-animation/animation-editor-using-hub-nodes-nohubgraph.png)
The same graph with **Hub** nodes simplifies transitions between the groups, which makes the graph cleaner and easier to read\.  

![\[Anim graph that is simplified with Hub nodes.\]](/images/actor-animation/animation-editor-using-hub-nodes-graphwithhubs.png)
...
![\[Use the Anim Graph Palette or the graph's context menu to place a Hub node in the Anim Graph.\]](/images/actor-animation/animation-editor-using-hub-nodes-palette.png)
...
![\[Add multiple like nodes between the two Hub nodes to simplify transitions.\]](/images/actor-animation/animation-editor-using-hub-nodes-example.png)
...
![\[Set the Transition Time of any transitions entering a Hub node to 0.0 to prevent introducing extra delays.\]](/images/actor-animation/animation-editor-using-hub-nodes-transitiontime.png)