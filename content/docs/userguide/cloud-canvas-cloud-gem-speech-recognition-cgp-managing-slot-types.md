...
![\[Managing slot types\]](http://docs.aws.amazon.com/lumberyard/latest/userguide/images/cloud_canvas/cloud-canvas-cloud-gem-speech-recognition-cgp-managing-slot-types-numbered.png)

1. To create a slot type, click **Create Slot Type**\. You must enter a unique name for the slot type and at least one value\.  
![\[Creating a slot type\]](http://docs.aws.amazon.com/lumberyard/latest/userguide/images/cloud_canvas/cloud-canvas-cloud-gem-speech-recognition-cgp-managing-slot-types-creating.png)
...
![\[Editing a slot type\]](http://docs.aws.amazon.com/lumberyard/latest/userguide/images/cloud_canvas/cloud-canvas-cloud-gem-speech-recognition-cgp-managing-slot-types-editing.png)