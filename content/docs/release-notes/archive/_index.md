...
{{< note >}}
Source versions use the `XXXX.Y` numbering model. Binary releases use `XX.XX FriendlyName` names, where the decimal place is moved to the left by 2 values from the original source code version.
{{< /note >}}
