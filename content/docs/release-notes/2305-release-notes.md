...
5.	Additional VR/XR support: Support for stereoscopic rendering (such as VR support) via OpenXR within O3DE.
...
* Made changes Users can choose to edit existing Gems `.json` files via the **Create a Gem** wizard or command line interface (CLI).
...
* Made multiple fixes and improvements to Editor's "Be this camera" functionality ([#14269](https://github.com/o3de/o3de/pull/14269), [#15119](https://github.com/o3de/o3de/pull/15119))
...
* Improved Editor extensibility with the introduction of a new Action Manager API that allows adding menus, hotkeys, and, contextual actions from Gems and/or Python scripts. 
<!-- Learn more about this feature at https://www.o3de.org/docs/user-guide/action-manager/index.md -->
...
* Added Material Canvas ([sig-graphics-audio#51](https://github.com/o3de/sig-graphics-audio/issues/51))
...
* Updated `LuaIDE` so developers can now override it and use a different Lua Editor/Debugger. For more information, refer to [Working with an External Lua Debugger](https://github.com/o3de/o3de/wiki/Working-With-An-External-Lua-Debugger).
...
* Provided a major update to the MultiplayerSample game: https://github.com/o3de/o3de-multiplayersample to provide a feature rich game experience with UX, audio, visual FX, player vs player and player vs environment elements.
 ...
 * Added a validation mechanism to identify when client and server have differences in networked code and properties to aid debugging of these issues.
...
* Provided a more out-of-the-box demonstration of Amazon GameLift using the new multiplayer sample with workflow refinements to make it easier to setup and use.
...
* Added support for PhysX 5.1 ([#13624](https://github.com/o3de/o3de/issues/13624)) (refer to [Known Issues](#known-issues) and [New and Noteworthy](#new-and-noteworthy) for details).
...
* Improved Animation Asset Import ([#12387](https://github.com/o3de/o3de/issues/12387))
	* Improved several quality of life features to the animation import process to make the overall experience more robust and straightforward.
