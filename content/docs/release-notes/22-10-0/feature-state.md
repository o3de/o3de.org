...
| Module | Feature | Functional | Content | Code/API | Performance | Platform | Github Link | Doc Link |
| :-- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| Deferred Fog | 🟢 Complete | 🟡 Partial | ⭕ Not Required | 🟢 Stable | 🟢 Optimized | All  | || [Link](https://docs.o3de.org/docs/user-guide/components/reference/atom/deferred-fog/) | |
...
| Skinned Meshes | 🟡 Active | 🟡 Partial | 🟢 Complete | 🟢 Stable | 🟡 Needs Optimization | All  | || [Link](https://www.o3de.org/docs/atom-guide/features/#meshes) | |
...
| HDR Pipeline | 🟢 Complete | 🟢 Complete | 🟢 Complete | 🟢 Stable | 🟡 Needs Optimization | All  | || [Link](https://www.o3de.org/docs/atom-guide/features/) | |
| Shadows | 🟡 Active | 🟡 Partial | 🟢 Complete | 🔵 In Progress | 🟡 Needs Optimization | All  | || [Link](https://www.o3de.org/docs/user-guide/components/reference/atom/light/) | |
| Skybox and Physical Sky | 🟢 Complete | 🟡 Partial | 🟢 Complete | 🟢 Stable | 🟡 Needs Optimization | All  | || [Link](https://www.o3de.org/docs/atom-guide/features/#lighting) | |
| SSAO | 🟢 Complete | 🟢 Complete | 🟢 Complete | 🟢 Stable | 🟢 Optimized | All  | || [Link](https://www.o3de.org/docs/atom-guide/features/#post-processing-effects-postfx) | |
| Color Grading | 🟢 Complete | 🟢 Complete | 🟢 Complete | 🟢 Stable | 🟡 Needs Optimization | All  | || [Link](https://www.o3de.org/docs/atom-guide/features/#post-processing-effects-postfx) | |
| Depth of Field | 🟢 Complete | 🟢 Complete | 🟢 Complete | 🟢 Stable | 🟡 Needs Optimization | All  | || [Link](https://www.o3de.org/docs/atom-guide/features/#post-processing-effects-postfx) | |
...
| Post Processing Volumes | 🟢 Complete | 🟢 Complete | 🟢 Complete | 🟢 Stable | 🟡 Needs Optimization | All  | || [Link](https://www.o3de.org/docs/atom-guide/features/#post-processing-effects-postfx) | |
| Decals | 🟡 Active | 🟢 Complete | 🟢 Complete | 🟢 Stable | 🟡 Needs Optimization | All  | || [Link](https://www.o3de.org/docs/atom-guide/features/#lighting) | |
| Screen Space Reflections | 🟢 Complete | 🟢 Complete | 🟢 Complete | 🟢 Stable | 🟡 Needs Optimization | All  | || [Link](https://www.o3de.org/docs/atom-guide/features/#post-processing-effects-postfx) | |
...
| Temporal Anti-aliasing (TAA) | 🟡 Active | 🟡 Partial | 🟢 Complete | 🔵 In Progress | 🟡 Needs Optimization | All  | || [Link](https://www.o3de.org/docs/atom-guide/features/#post-processing-effects-postfx) | |

### Render Hardware Interface 

| Module | Feature | Functional | Content | Code/API | Performance | Platform | Github Link | Doc Link |
| :-- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| DirectX 12 | 🟡 Active | 🟢 Complete | ⭕ Not Required | 🟢 Stable | 🟡 Needs Optimization | || || [Link](https://www.o3de.org/docs/atom-guide/dev-guide/rhi/) | |
| Vulkan | 🟡 Active | 🟢 Complete | ⭕ Not Required | 🟢 Stable | 🟡 Needs Optimization | || || [Link](https://www.o3de.org/docs/atom-guide/dev-guide/rhi/) | |
| Metal | 🟡 Active | 🟡 Partial | ⭕ Not Required | 🟠 Volatile | 🟡 Needs Optimization | || || [Link](https://www.o3de.org/docs/atom-guide/dev-guide/rhi/) | |
...
| Module | Feature | Functional | Content | Code/API | Performance | Platform | Github Link | Doc Link |
| :-- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| Transport API | 🟢 Complete | 🟡 Partial | ❌ None | ❌ Unproven | 🟡 Needs Optimization | || || [Link](https://www.o3de.org/docs/user-guide/networking/) | |
| Multiple network interface support | 🟢 Complete | 🟡 Partial | ❌ None | ❌ Unproven | 🟡 Needs Optimization | || || [Link](https://www.o3de.org/docs/user-guide/networking/) | |
| Compression (TCP/UDP) | 🟢 Complete | 🟢 Complete | ❌ None | ❌ Unproven | 🟡 Needs Optimization | || || [Link](https://www.o3de.org/docs/user-guide/gems/reference/multiplayer/multiplayer-compression/) | |
| Metrics support | 🟢 Complete | 🟡 Partial | ❌ None | ❌ Unproven | 🟡 Needs Optimization | || || || |
| UDP Core | 🟢 Complete | 🟡 Partial | ❌ None | ❌ Unproven | 🟡 Needs Optimization | || || || |
| UDP: DTLS support | 🟢 Complete | 🟢 Complete | ❌ None | ❌ Unproven | 🟡 Needs Optimization | || || [Link](https://www.o3de.org/docs/user-guide/networking/encryption/) | |
| UDP: Reliable queue support | 🟢 Complete | 🟡 Partial | ❌ None | ❌ Unproven | 🟡 Needs Optimization | || || || |
| UDP: Fragmented packet support | 🟢 Complete | 🟡 Partial | ❌ None | ❌ Unproven | 🟡 Needs Optimization | || || || |
| TCP | 🟢 Complete | 🟢 Complete | ❌ None | ❌ Unproven | 🟡 Needs Optimization | || || [Link](https://www.o3de.org/docs/user-guide/networking/packets/) | |
| TCP: TLS Support | 🟢 Complete | 🟡 Partial | ❌ None | ❌ Unproven | 🟡 Needs Optimization | || || || |
| TCP: Ringbuffer support Pkg Xmit | 🟢 Complete | 🟡 Partial | ❌ None | ❌ Unproven | 🟡 Needs Optimization | || || || |

### Multiplayer 

| Module | Feature | Functional | Content | Code/API | Performance | Platform | Github Link | Doc Link |
| :-- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| Multiplayer component API | 🟢 Complete | 🟡 Partial | ❌ None | ❌ Unproven | 🟡 Needs Optimization | || || || |
| Local Prediction | 🟢 Complete | 🟡 Partial | ❌ None | ❌ Unproven | 🟡 Needs Optimization | || || || |
| Server Side Rollback | 🟢 Complete | 🟡 Partial | ❌ None | ❌ Unproven | 🟡 Needs Optimization | || || || |
| Play in Editor Mode | 🟡 Active | 🟡 Partial | ❌ None | ❌ Unproven | 🟡 Needs Optimization | || || [Link](https://docs.o3de.org/docs/user-guide/gems/reference/multiplayer/multiplayer-gem/test-in-editor/) | |
| Hosting/Joining a Game | 🟡 Active | 🟡 Partial | ❌ None | ❌ Unproven | 🟡 Needs Optimization | || || || |
| Network property support | 🟢 Complete | 🟡 Partial | ❌ None | ❌ Unproven | 🟡 Needs Optimization | || || [Link](https://www.o3de.org/docs/user-guide/networking/autopackets/) | |
| RPC support | 🟢 Complete | 🟡 Partial | ❌ None | ❌ Unproven | 🟡 Needs Optimization | || || || |
| Network Input support | 🟢 Complete | 🟡 Partial | ❌ None | ❌ Unproven | 🟡 Needs Optimization | || || || |
| ScriptBind support | 🟢 Complete | 🟡 Partial | ❌ None | ❌ Unproven | 🟡 Needs Optimization | || || || |
| Netbound entity support [NetBindComponent] | 🟢 Complete | 🟡 Partial | ❌ None | ❌ Unproven | 🟡 Needs Optimization | || || || |
| Entity replication support | 🟢 Complete | 🟡 Partial | ❌ None | ❌ Unproven | 🟡 Needs Optimization | || || || |
| Network Prefab Spawning | 🟡 Active | 🟡 Partial | ❌ None | ❌ Unproven | 🔴 Needs Testing | || || || |
...
| Network Simulation (Physics) | 🟢 Complete | 🟡 Partial | ❌ None | ❌ Unproven | 🟡 Needs Optimization | || || || |
| Quality of Service | 🟡 Active | 🟡 Partial | ❌ None | ❌ Unproven | 🟡 Needs Optimization | || || || |
| Debugging Tools | 🟡 Active | 🟡 Partial | ❌ None | ❌ Unproven | 🟡 Needs Optimization | || || || |
| Metrics | 🟡 Active | 🟡 Partial | ❌ None | ❌ Unproven | 🟡 Needs Optimization | || || || |
...
| Array | 🔵 Backlogged | 🟠 Minimal | ❌ None | 🟢 Stable | 🔴 Needs Testing | Windows Linux MacOS  | || <br> |
