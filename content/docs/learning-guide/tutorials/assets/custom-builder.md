...
This topic assumes that you have a working knowledge of O3DE [Gems](/docs/userguide/gems/structure.md), [AZ::Modules](/docs/userguide/modules/parts.md), and [AZ::Components](/docs/user-guide/engine/components/create-component.md)\. The next section includes a brief overview of asset builders inside gems\.
...
For more information about declaring, enabling, or disabling platforms, see [Configuring the Asset Pipeline](/docs/user-guide/assets/configuring.md)\.
