...
Extend the O3DE Editor by creating a custom tool Gem. A tool is a dockable widget or dialog window that implements functionality to O3DE Editor. You can create custom tools in C++ or Python.
