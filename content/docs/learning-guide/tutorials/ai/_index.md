...
weight: 100
---
Prerequisites: Your own project with Kythera Gem enabled or the Kythera ShooterDemo project, as documented here: [Kythera AI Gem Setup](/docs/user-guide/gems/reference/kythera-ai/)
