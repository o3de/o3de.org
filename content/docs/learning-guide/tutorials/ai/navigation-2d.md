...
You will need to begin from either your own project with the Kythera AI Gem enabled, or the Kythera AI Demo project. See [Kythera AI Gem Setup](/docs/user-guide/gems/reference/kythera-ai/kythera-ai-gem-setup/) for instructions.
