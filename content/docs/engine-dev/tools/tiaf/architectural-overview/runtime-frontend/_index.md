...
Below are the actions that will be enacted by the native and Python `TestSelectorAndPrioritizor`s in response to source file CRUD changes. Listed is each possible permutation given a CRUD operation and an entry in the Source to Target Mapping artifact(s) and/or the Source Dependency List.

#### Native CRUD Rules

Below is the CRUD rule rubrik for the `TestSelectorAndPrioritizor` that is used by the native runtime. The implementation of these rules can be found [here](https://github.com/o3de/o3de/blob/development/Code/Tools/TestImpactFramework/Runtime/Common/Code/Include/Static/Dependency/TestImpactTestSelectorAndPrioritizer.h).

|        | Parent Target(s)? | Coverage Data? | Source Type   | Scenario                                                                                                        | Action                                                                                     |
|--------|-------------------|----------------|---------------|-----------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------|
| Create | Yes               | No             | Production    | 1. The file has been newly created.                                                                             | 1. Select all test targets covering the parent production targets.                         |
...
|        |                   |                | Test          | 1. The file has been newly created.                                                                             | 1. Select all parent test targets.                                                         |
|        |                   |                |               | 2. This file exists in one or more source to test target mapping artifacts.                                     |                                                                                            |
|        |                   |                |               | 3. There exists no coverage data for this file in the Source Covering Test List.                                |                                                                                            |
|        | No                | Yes            | Indeterminate | 1. This file previously existed in one or more source to target mapping artifacts.                              | 1. Log *Source Covering Test List integrity compromised* error.                              |
|        |                   |                |               | 2. The file has since been deleted yet no delete crud operation was acted upon:                                 | 2. Throw exception.                                                                        |
|        |                   |                |               | 1. The coverage data for this file was not deleted from the Source Covering Test List.                          |                                                                                            |
|        |                   |                |               | 3. The file has since been recreated.                                                                           |                                                                                            |
|        |                   |                |               | 4. This file does not exists in any source to target mapping artifacts.                                         |                                                                                            |
|        | No                | No             | Indeterminate | 1. The file has been newly created.                                                                             | 1. Skip the file.                                                                          |
|        |                   |                |               | 2. This file does not exists in any source to target mapping artifacts.                                         |                                                                                            |
|        | Yes               | Yes            | Irrelevant    | 1. This file previously existed in one or more source to target mapping artifacts.                              | 1. Log *Source Covering Test List compromised* error.                                        |
|        |                   |                |               | 2. The file has since been deleted yet no delete crud operation acted upon:                                     |                                                                                            |
|        |                   |                |               | 1. The coverage data for this file was not deleted from the Source Covering Test List.                          | 2. Throw exception.                                                                        |
|        |                   |                |               | 3. The file has since been recreated.                                                                           |                                                                                            |
|        |                   |                |               | 4. This file exists in one or more source to target mapping artifacts.                                          |                                                                                            |
| Update | Yes               | No             | Production    | 1. The existing file has been modified.                                                                         | 1. Skip the file.                                                                          |
|        |                   |                |               | 2. This file exists in one or more source to production target mapping artifacts.                               |                                                                                            |
|        |                   |                |               | 3. There exists no coverage data for this file in the Source Covering Test List.                                |                                                                                            |
|        |                   |                | Test          | 1. The existing file has been modified.                                                                         | 1. Select all parent test targets for this file.                                           |
|        |                   |                |               | 2. This file exists in one or more source to test target mapping artifacts.                                     |                                                                                            |
|        |                   |                |               | 3. There exists no coverage data for this file in the Source Covering Test List.                                |                                                                                            |
|        | No                | Yes            | Indeterminate | 1. The existing file has been modified.                                                                         | 1. Log *potential orphaned source file* warning.                                             |
|        |                   |                |               | 2. Either:                                                                                                      |                                                                                            |
|        |                   |                |               | 1. This file previously existed in one or more source to target mapping artifacts.                              | 2. Select all test targets covering this file.                                             |
|        |                   |                |               | 2. This file no longer exists in any source to target mapping artifacts.                                        | 3. Delete the existing coverage data from the Source Covering Test List.                   |
|        |                   |                |               | 3. The coverage data for this file was has yet to be deleted from the Source Covering Test List.                |                                                                                            |
|        |                   |                |               | 3. Or:                                                                                                          |                                                                                            |
|        |                   |                |               | 1. The file is being used by build targets but has erroneously not been explicitly added (e.g. header include). |                                                                                            |
|        | No                | No             | Indeterminate | 1. The existing file has been modified.                                                                         | 1. Skip the file.                                                                          |
|        |                   |                |               | 2. This file does not exist in any source to target mapping artifacts.                                          |                                                                                            |
|        |                   |                |               | 3. There exists no coverage data for this file in the Source Covering Test List.                                |                                                                                            |
|        | Yes               | Yes            | Production    | 1. The existing file has been modified.                                                                         | 1. Select all test targets covering this file.                                             |
|        |                   |                |               | 2. This file exists in one or more source to production target mapping artifacts.                               |                                                                                            |
|        |                   |                |               | 3. There exists coverage data for this file in the Source Covering Test List.                                   |                                                                                            |
|        |                   |                | Test          | 1. The existing file has been modified.                                                                         | 1. Select the parent test targets for this file.                                           |
|        |                   |                |               | 2. This file exists in one or more source to test target mapping artifacts.                                     |                                                                                            |
|        |                   |                |               | 3. There exists coverage data for this file in the Source Covering Test List.                                   |                                                                                            |
| Delete | Yes               | No             | Irrelevant    | 1. The file has been deleted.                                                                                   | 1. Log *source to target mapping integrity compromised* error.                               |
|        |                   |                |               | 2. This file still exists in one or more source to target mapping artifacts.                                    | 2. Throw exception.                                                                        |
|        |                   |                |               | 3. There exists no coverage data for this file in the Source Covering Test List.                                |                                                                                            |
|        | No                | Yes            | Indeterminate | 1. The file has been deleted.                                                                                   | 1. Select all test targets covering this file.                                             |
|        |                   |                |               | 2. This file previously existed in one or more source to target mapping artifacts.                              | 2. Delete the existing coverage data from the Source Covering Test List.                   |
...
|        | No                | No             | Indeterminate | 1. The file has been deleted.                                                                                   | 1. Skip the file.                                                                          |
|        |                   |                |               | 2. This file does not exist in any source to target mapping artifacts.                                          |                                                                                            |
|        |                   |                |               | 3. There exists no coverage data for this file in the Source Covering Test List.                                |                                                                                            |
|        | Yes               | Yes            | Irrelevant    | 1. The existing file has been deleted.                                                                          | 1. Log *source to target mapping* and *Source Covering Test List integrity compromised* error. |
|        |                   |                |               | 2. This file still exists in one or more source to target mapping artifacts.                                    | 2. Throw exception.                                                                        |
|        |                   |                |               | 3. There exists coverage data for this file in the Source Covering Test List.                                   |                                                                                            |

### Python CRUD Rules

Below is the CRUD rule rubrik for the `PythonTestSelectorAndPrioritizor` that is used by the native runtime. The implementation of these rules can be found [here](https://github.com/o3de/o3de/blob/development/Code/Tools/TestImpactFramework/Runtime/Python/Code/Source/Dependency/TestImpactPythonTestSelectorAndPrioritizer.h).

|        | Parent Target(s)? | Source Coverage Data? | Parent Coverage Data? | Source Type   | Scenario                                                                                                        | Action                                                                                     |
|--------|-------------------|-----------------------|-----------------------|---------------|-----------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------|
| Create | Yes               | No                    | All                   | Production    | 1. The file has been newly created.                                                                             | 1. Select all test targets covering the parent production targets.                         |
|        |                   |                       |                       |               | 2. This file exists in one or more source to production target mapping artifacts.                               |                                                                                            |
|        |                   |                       |                       |               | 3. There exists no coverage data for this file in the Source Covering Test List.                                |                                                                                            |
|        |                   |                       |                       |               | 4. All parent targets have coverage data in the Source Covering Test List.                                      |                                                                                            |
|        |                   |                       |                       | Test          | 1. The file has been newly created.                                                                             | 1. Select all parent test targets for this file.                                           |
|        |                   |                       |                       |               | 2. This file exists in one or more source to test target mapping artifacts.                                     |                                                                                            |
|        |                   |                       |                       |               | 3. There exists no coverage data for this file in the Source Covering Test List.                                |                                                                                            |
|        |                   |                       |                       |               | 4. All parent test targets have coverage data in the Source Covering Test List.                                 |                                                                                            |
|        |                   |                       | Mixed to None         | Production    | 1. The file has been newly created.                                                                             | 1. Select all test targets.                                                                |
|        |                   |                       |                       |               | 2. This file exists in one or more source to production target mapping artifacts.                               |                                                                                            |
|        |                   |                       |                       |               | 3. There exists no coverage data for this file in the Source Covering Test List.                                |                                                                                            |
...
|        |                   |                       |                       |               | 2. This file exists in one or more source to test target mapping artifacts.                                     |                                                                                            |
|        |                   |                       |                       |               | 3. There exists no coverage data for this file in the Source Covering Test List.                                |                                                                                            |
|        |                   |                       |                       |               | 4. One or more parent test targets do not have coverage data in the Source Covering Test List.                  |                                                                                            |
|        | No                | Yes                   | N/A                   | Indeterminate | 1. This file previously existed in one or more source to target mapping artifacts.                              | 1. Log *Source Covering Test List integrity compromised* error.                              |
|        |                   |                       |                       |               | 2. The file has since been deleted yet no delete crud operation was acted upon:                                 | 2. Throw exception.                                                                        |
|        |                   |                       |                       |               | 1. The coverage data for this file was not deleted from the Source Covering Test List.                          |                                                                                            |
|        |                   |                       |                       |               | 3. The file has since been recreated.                                                                           |                                                                                            |
|        |                   |                       |                       |               | 4. This file does not exists in any source to target mapping artifacts.                                         |                                                                                            |
|        | No                | No                    | N/A                   | Indeterminate | 1. The file has been newly created.                                                                             | 1. Skip the file.                                                                          |
|        |                   |                       |                       |               | 2. This file does not exists in any source to target mapping artifacts.                                         |                                                                                            |
|        | Yes               | Yes                   | Irrelevant            | Irrelevant    | 1. This file previously existed in one or more source to target mapping artifacts.                              | 1. Log *Source Covering Test List integrity compromised* error.                              |
|        |                   |                       |                       |               | 2. The file has since been deleted yet no delete crud operation acted upon:                                     | 2. Throw exception.                                                                        |
|        |                   |                       |                       |               | 1. The coverage data for this file was not deleted from the Source Covering Test List.                          |                                                                                            |
|        |                   |                       |                       |               | 3. The file has since been recreated.                                                                           |                                                                                            |
|        |                   |                       |                       |               | 4. This file exists in one or more source to target mapping artifacts.                                          |                                                                                            |
| Update | Yes               | No                    | All                   | Production    | 1. The existing file has been modified.                                                                         | 1. Select all test targets covering the parent production targets.                         |
|        |                   |                       |                       |               | 2. This file exists in one or more source to production target mapping artifacts.                               |                                                                                            |
|        |                   |                       |                       |               | 3. There exists no coverage data for this file in the Source Covering Test List.                                |                                                                                            |
|        |                   |                       |                       |               | 4. All parent targets have coverage data in the Source Covering Test List.                                      |                                                                                            |
|        |                   |                       |                       | Test          | 1. The existing file has been modified.                                                                         | 1. Select all parent test targets for this file.                                           |
...
|        |                   |                       |                       |               | 3. There exists no coverage data for this file in the Source Covering Test List.                                |                                                                                            |
|        |                   |                       |                       |               | 4. All parent test targets have coverage data in the Source Covering Test List.                                 |                                                                                            |
|        |                   |                       | Mixed to None         | Production    | 1. The existing file has been modified.                                                                         | 1. Select all test targets.                                                                |
|        |                   |                       |                       |               | 2. This file exists in one or more source to production target mapping artifacts.                               |                                                                                            |
|        |                   |                       |                       |               | 3. There exists no coverage data for this file in the Source Covering Test List.                                |                                                                                            |
|        |                   |                       |                       |               | 4. One or more parent targets do not have coverage data in the Source Covering Test List.                       |                                                                                            |
|        |                   |                       |                       | Test          | 1. The existing file has been modified.                                                                         | 1. Select all parent test targets for this file.                                           |
...
|        |                   |                       |                       |               | 3. There exists no coverage data for this file in the Source Covering Test List.                                |                                                                                            |
|        |                   |                       |                       |               | 4. One or more parent test targets do not have coverage data in the Source Covering Test List.                  |                                                                                            |
|        | No                | Yes                   | N/A                   | Indeterminate | 1. The existing file has been modified.                                                                         | 1. Log *potential orphaned source file* warning.                                             |
|        |                   |                       |                       |               | 2. Either:                                                                                                      |                                                                                            |
|        |                   |                       |                       |               | 1. This file previously existed in one or more source to target mapping artifacts.                              | 2. Select all test targets covering this file.                                             |
|        |                   |                       |                       |               | 2. This file no longer exists in any source to target mapping artifacts.                                        | 3. Delete the existing coverage data from the Source Covering Test List.                   |
|        |                   |                       |                       |               | 3. The coverage data for this file was has yet to be deleted from the Source Covering Test List.                |                                                                                            |
|        |                   |                       |                       |               | 3. Or:                                                                                                          |                                                                                            |
|        |                   |                       |                       |               | 1. The file is being used by build targets but has erroneously not been explicitly added (e.g. header include). |                                                                                            |
|        | No                | No                    | N/A                   | Indeterminate | 1. The existing file has been modified.                                                                         | 1. Skip the file.                                                                          |
|        |                   |                       |                       |               | 2. This file does not exist in any source to target mapping artifacts.                                          |                                                                                            |
|        |                   |                       |                       |               | 3. There exists no coverage data for this file in the Source Covering Test List.                                |                                                                                            |
|        | Yes               | Yes                   | Yes                   | Production    | 1. The existing file has been modified.                                                                         | 1. Select all test targets covering this file.                                             |
|        |                   |                       |                       |               | 2. This file exists in one or more source to production target mapping artifacts.                               |                                                                                            |
|        |                   |                       |                       |               | 3. There exists coverage data for this file in the Source Covering Test List.                                   |                                                                                            |
|        |                   |                       |                       |               | 4. All parent targets have coverage data in the Source Covering Test List.                                      |                                                                                            |
|        |                   |                       |                       | Test          | 1. The existing file has been modified.                                                                         | 1. Select the parent test targets for this file.                                           |
...
|        |                   |                       |                       |               | 3. There exists coverage data for this file in the Source Covering Test List.                                   |                                                                                            |
|        |                   |                       |                       |               | 4. One or more parent test targets do not have coverage data in the Source Covering Test List.                  |                                                                                            |
| Delete | Yes               | No                    | Irrelevant            | Irrelevant    | 1. The file has been deleted.                                                                                   | 1. Log *Source Covering Test List integrity compromised* error.                              |
|        |                   |                       |                       |               | 2. This file still exists in one or more source to target mapping artifacts.                                    | 2. Throw exception.                                                                        |
|        |                   |                       |                       |               | 3. There exists no coverage data for this file in the Source Covering Test List.                                |                                                                                            |
|        | No                | Yes                   | N/A                   | Indeterminate | 1. The file has been deleted.                                                                                   | 1. Select all test targets covering this file.                                             |
|        |                   |                       |                       |               | 2. This file previously existed in one or more source to target mapping artifacts.                              | 2. Delete the existing coverage data from the Source Covering Test List.                   |
|        |                   |                       |                       |               | 3. This file no longer exists in any source to target mapping artifacts.                                        | 3. Skip the file.                                                                          |
|        |                   |                       |                       |               | 4. The coverage data for this file was has yet to be deleted from the Source Covering Test List.                |                                                                                            |
|        | No                | No                    | N/A                   | Indeterminate | 1. The file has been deleted.                                                                                   | 1. Skip the file.                                                                          |
|        |                   |                       |                       |               | 2. This file does not exist in any source to target mapping artifacts.                                          |                                                                                            |
|        |                   |                       |                       |               | 3. There exists no coverage data for this file in the Source Covering Test List.                                |                                                                                            |
